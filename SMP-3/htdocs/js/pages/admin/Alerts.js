Class.add( Page.Admin, {
	...
	get_alert_edit_html: function() {
		...
		html += get_form_table_caption( 
			...
			'you can use the <span class="link" onMouseUp="$P().showHostDataExplorer(\'#fe_ea_expression\')">Server Data Explorer</span>, or view the <a href="https://github.com/performa#alert-expressions" target="_blank">documentation</a>.'
		);
		html += get_form_table_spacer();
		...
		html += get_form_table_caption( 
			...
			'You can use <a href="https://github.com/performa#alert-expressions" target="_blank">alert expressions</a> here.'
		);
		html += get_form_table_spacer();
