...
class Users
{
  ...
  public function getArticlesKeyword($keyword)
  {
    $sql = "SELECT * FROM tbl_article where article_title like '%" . $keyword . "%'";
  ...
  public function getArticlesByKeyword($keyword, $n)
  {
    $sql = "SELECT * FROM tbl_article where article_title like '%" . $keyword . "%' LIMIT " . $n;
  ...
  public function sendOTP($data)
  {
    ...
    if ($stmt->rowCount() > 0) {
      ...
      $mail->Username   = "tez.zhang@gmail.com";
      $mail->Password   = "Tezzhang1!";

      $mail->IsHTML(true);
      $mail->AddAddress($email, $email);
      $mail->SetFrom("tez.zhang@gmail.com", "Misinformation Admin");
      $mail->Subject = "OTP";
      $content = "<b>Here is your OTP : </b>" . $result->otp;
...
<strong>Error !</strong> Email already Exists, please try another Email... !</div>';
  ...
  {
    $sql = "SELECT * FROM tbl_users WHERE token = :id LIMIT 1";
    $stmt = $this->db->pdo->prepare($sql);
